# utl-add-a-tab-to-excel-that-autmatically-impot-a-sas-datasets-www.colectica-com
Add a tab to excel that autmatically import sas datasets www colectica.com
    %let pgm=utl-add-a-tab-to-excel-that-autmatically-impot-a-sas-datasets-www.colectica-com;

    Add a tab to excel that autmatically import sas datasets www colectica.com

    github
    http://tinyurl.com/59vycau9
    ...
    Note: R and Python can covert a sas dataset to excel, but Colectica does not
          require R an is easier to use.
    ...
    Requirements (no haggling required and prices online are available for everyone.
      You will not get confused by multiple different sales pitches and prices.

       Professional $1   per month billed yearly
       Professional $49  perpetual  (i have this one)

     Download and you will see

       ColecticaForExcel-WebSetup-6.2.8934.exe
       colectica activation key.txt
       applying key may have changes, my install is quite old

       If you update or install a different version of Excel just
       go to programs and click on coletica and reoair installation.
       No need for activation key, if you have activated

       You will need to restart, it installs a specific MS C++
    ...
    */
    ...
    Click on
       ...
       or (supply your useris instead of Roger
       C:\Users\Roger\Downloads\ColecticaForExcel-WebSetup-6.2.8934.exe

       Apply colectica activation key.txt

    After install

    When you open excel you will see an extra tab 'COLECTICA'

                                            ========
     [ FILE HOME INSERT PAGE LAYOUT FORMULAS COLECTICA REVIEW VIEW DEVELOPER ]
                                            =========
      d:/xls/class.xlsx
    ...
    /**************************************************************************************************************************/
    /*                                                                                                                        */
    /*  Click on 'COLECTICA'  and a pull down banner will appear                                                              */
    /*                                                                                                                        */
    /* +-------------------------------------------------------------------------------+                                      */
    /* |           |                |        |        |        |       |               |                                      */
    /* |           |  Data          |        |        |        |       |  Create       |                                      */
    /* |  Document |  Documentation |  From  |  From  |  From  | Save  |  Documentation|                                      */
    /* |  Workbook |  Review        |  SPSS  |  STATA |  SAS   | as DDI|               |                                      */
    /* |           |                |        |        |        |       |               |                                      */
    /* +-------------------------------------------------------------------------------+                                      */
    /*                                                                                                                        */
    /*  Click on 'From SAS'                                                                                                   */
    ...
    /* |                                                                               |                                      */
    /* |                                                                               |                                      */
    /* |      Select SAS data file (you cannot paste you need to click on   [...]      |                                      */
    /* |                                                                               |                                      */
    /* |      +------------------------+  +---+                                        |                                      */
    ...
    /* |      +------------------------+  +---+                                        |                                      */
    /* |                                                                               |                                      */
    /* |      [X] convert missing to empty cells                                       |                                      */
    /* +-------------------------------------------------------------------------------+                                      */
    /*                                                                                                                        */
    /**************************************************************************************************************************/
    ...
    */
    ...
    https://github.com/rogerjdeangelis/utl-create-sas-table-using-an-excel-range
